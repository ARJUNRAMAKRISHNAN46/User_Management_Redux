        ...
        if (!errors.emailred && !errors.namered && !errors.passwordred && !errors.confirmpasswordred) {
            async function register() {
                try {
                    ...
                    await axios.post('http://localhost:4014/signup/', userData,{withCredentials:true})
                        .then((response) => {
                            if (response.data.success) {
                                axios.get('http://localhost:4014/fetchuserdata/', {
        ...
        <>
            <div className="h-screen w-screen bg-gray-900 flex justify-center items-center">
                <div className="w-[70%] md:w-[28%] h-[90%] border border-gray-500 rounded flex flex-col items-center justify-center gap-8 pt-4">
                    ...
                    />
                    <button onClick={handleSubmission} className=" w-[80%] h-[8%] rounded bg-white text-gray-900 font-bold hover:bg-gray-300">Signup</button>
